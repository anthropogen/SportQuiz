...
namespace NaughtyAttributes.Editor
{
  ...
  public class ScenePropertyDrawer : PropertyDrawerBase
  {
    ...
    private static void DrawPropertyForString(Rect rect, SerializedProperty property, GUIContent label, string[] scenes,
      string[] sceneOptions)
    {
      ...
      if (!property.stringValue.Equals(newScene, StringComparison.Ordinal)) property.stringValue = scenes[newIndex];
    }
